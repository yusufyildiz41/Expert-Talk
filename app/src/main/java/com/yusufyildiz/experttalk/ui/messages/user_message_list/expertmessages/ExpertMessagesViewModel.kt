...
@HiltViewModel
class ExpertMessagesViewModel @Inject constructor(
    ...
    fun addSession(userEmail: String, expertEmail: String){
        viewModelScope.launch {
            val result = chatSocketService.initSession(userEmail,expertEmail)
            when(result){
                is Resource.Success -> {
